...
class HeatControlWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        myLayout.addWidget(self.controller, 1, 1,2,1)
        myLayout.addWidget(self.heater, 1, 2,2,1)
        myLayout.addWidget(self.gastherme, 1, 3,2,1)
        myLayout.addWidget(self.notaus, 3, 3)
        myLayout.addWidget(self.diagram.graphWidget,3, 1, 2, 2)
